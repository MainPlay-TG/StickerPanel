...
### Установка
- Windows
  1. Скачайте файл [StickerPanelWindows.zip](dist/StickerPanelWindows.zip)
  2. Распакуйте файл в пустую папку
  3. Для запуска используйте файл `StickerPanel.exe` в этой папке
- Другая ОС
  1. (пока нету инструкции, берите код из папки [src](src/))
### Настройка
1. Запустите [GetStickersDir.py](GetStickersDir.py) чтобы узнать где хранятся стикеры программы
